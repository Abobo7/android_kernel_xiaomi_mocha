...
static int __init binder_init(void)
{
	...
	/* libhwbinder's FDA wire format includes this pad even with 32-bit IPC. */
	BUILD_BUG_ON(offsetof(struct binder_fd_array_object, num_fds) != 8);
	BUILD_BUG_ON(sizeof(struct binder_fd_array_object) !=
		     8 + 3 * sizeof(binder_size_t));
